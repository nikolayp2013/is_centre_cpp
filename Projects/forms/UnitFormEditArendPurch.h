...
#ifndef UnitFormEditArendPurchH
#define UnitFormEditArendPurchH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TFormEditArendPurch : public TForm
{
...
public:		// User declarations
	__fastcall TFormEditArendPurch(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFormEditArendPurch *FormEditArendPurch;
//---------------------------------------------------------------------------
#endif
