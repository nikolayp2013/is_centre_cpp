...
TFormEditLandSell *FormEditLandSell;
...
void __fastcall TFormEditLandSell::FormCreate(TObject *Sender)
{
...
//---------------------------------------------------------------------------
__fastcall TFormEditLandSell::TFormEditLandSell(TComponent* Owner)
			: TForm(Owner)
{
	...
	Table_Items_10->Filter="RAZDEL=82";
	...
	Table_Variant->Filter="RAZDEL=85";
	...
	//Таблица со списком состояний участка
	...
	Table_Typehouse->Filter="RAZDEL=86";
	...
	//Таблица со объектов недвижимости
	...
	Table_Stuffwall->Filter="RAZDEL=81";
	...
	Table_Swphone->Filter="RAZDEL=76";
	...
	//Таблица со списком предложений
	...
	Table_Nodesan->Filter="RAZDEL=83";
...
//---------------------------------------------------------------------------
void __fastcall TFormEditLandSell::ProcRefreshClient(TObject *Sender)
{
...
void __fastcall TFormEditLandSell::FormShow(TObject *Sender)
{
	//Район
	...
	// Объект
	Realstate_DBLookupComboBoxCentre->ListSource=Stuffwall_datasource;
	...
	// Право
	Formowner_DBLookupComboBoxCentre->ListSource=mRegion_datasource;
	...
	// Предложение
	Formoffer_DBLookupComboBoxCentre->ListSource=Nodesan_datasource;
	...
	// Состояние участка
	Landstate_DBLookupComboBoxCentre->ListSource=Typehouse_datasource;
	Landstate_DBLookupComboBoxCentre->ListField="FULLNAME";
	Landstate_DBLookupComboBoxCentre->KeyField="CODE";
	Landstate_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Landstate_DBLookupComboBoxCentre->DataField="LANDSTATE";
	// Право на строение
	Houseowner_DBLookupComboBoxCentre->ListSource=Design_datasource;
	Houseowner_DBLookupComboBoxCentre->ListField="FULLNAME";
	Houseowner_DBLookupComboBoxCentre->KeyField="CODE";
	Houseowner_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Houseowner_DBLookupComboBoxCentre->DataField="HOUSEOWNER";
	// Прописка
	Writeowner_DBLookupComboBoxCentre->ListSource=Variant_datasource;
	Writeowner_DBLookupComboBoxCentre->ListField="FULLNAME";
	Writeowner_DBLookupComboBoxCentre->KeyField="CODE";
	Writeowner_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Writeowner_DBLookupComboBoxCentre->DataField="WRITEOWNER";
	// Вода
	Water_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Water_DBCheckBox->DataField="WATER";
	// Канализация
	...
	// Межевое дело
	Bound_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Bound_DBCheckBox->DataField="BOUND";
	// Свидетельство гос. регистрации
	Doc_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Doc_DBCheckBox->DataField="DOC";
	// Вода
	Wateradd_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Wateradd_DBEdit->DataField="WATERADD";
	// Канализация
	...
	Purposeuse_DBLookupComboBoxCentre->ListSource=Swphone_datasource;
	Purposeuse_DBLookupComboBoxCentre->ListField="FULLNAME";
	Purposeuse_DBLookupComboBoxCentre->KeyField="CODE";
	Purposeuse_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Purposeuse_DBLookupComboBoxCentre->DataField="PURPOSEUSE";
	// Зонирование
	Zone_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Zone_DBEdit->DataField="ZONE";
}
//---------------------------------------------------------------------------


void __fastcall TFormEditLandSell::PageControl1DrawTab(TCustomTabControl *Control, int TabIndex,
...
void __fastcall TFormEditLandSell::Streets_DBEditKeyUp(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditLandSell::Streets_DBLookupListBoxClick(TObject *Sender)
{
...
void __fastcall TFormEditLandSell::Streets_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditLandSell::Streets_DBEditExit(TObject *Sender)
{
...
void __fastcall TFormEditLandSell::Streets_DBLookupListBoxKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift)
{
	 if (Key==13) {
		if (Streets_DBLookupListBox->Top==98) {
...
void __fastcall TFormEditLandSell::Streets_DBLookupListBoxMouseUp(TObject *Sender, TMouseButton Button,
...
void __fastcall TFormEditLandSell::Streets_DBLookupListBoxExit(TObject *Sender)
{
	if (Streets_DBLookupListBox->Top==98) {
		Streets_DBEdit->DataSource->DataSet->FieldByName("STREET")->Value=
			Streets_DBLookupListBox->KeyValue;
...
void __fastcall TFormEditLandSell::Cross_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditLandSell::Cross_DBEditKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditLandSell::Cross_DBEditExit(TObject *Sender)
{
	if (!Streets_DBLookupListBox->Focused()){
		if (Cross_DBEdit->Text.Length()!=0) {
			Streets_DBEdit->DataSource->DataSet->FieldByName("CRSTREET")->Value=
...
void __fastcall TFormEditLandSell::OnApplicationMessage(TMsg & Msg, bool & Handled)
{
...
void __fastcall TFormEditLandSell::SpeedButton2Click(TObject *Sender)
{
    //Фиксация изменений
...
void __fastcall TFormEditLandSell::Button6Click(TObject *Sender)
{
...
void __fastcall TFormEditLandSell::Button4Click(TObject *Sender)
{
...
void __fastcall TFormEditLandSell::SpeedButton1Click(TObject *Sender)
{
...
void __fastcall TFormEditLandSell::SpeedButton3Click(TObject *Sender)
{
    MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("CLIENT")->AsInteger=0;
	// Вызов процедуры обновления сведений о клиенте
	ProcRefreshClient(this);
...
void __fastcall TFormEditLandSell::Button5Click(TObject *Sender)
{
	// Кнопка назад
...
void __fastcall TFormEditLandSell::Button3Click(TObject *Sender)
{
	// Кнопка вперед
...
void __fastcall TFormEditLandSell::ProcSave(TObject *Sender)
{
    //Фиксация изменений
	MainForm->TabPricelist_Datasource_Main->DataSet->CheckBrowseMode();
	//Записать изменения в базу данных
...
void __fastcall TFormEditLandSell::RefreshAgent(TObject *Sender)
{
...
void __fastcall TFormEditLandSell::Agent_ComboBoxClick(TObject *Sender)
{
	 Agent_datasource->DataSet->Active=true;
	 Agent_datasource->DataSet->First();
...
void __fastcall TFormEditLandSell::Button1Click(TObject *Sender)
{
...
void __fastcall TFormEditLandSell::Button2Click(TObject *Sender)
{
...
void __fastcall TFormEditLandSell::Button7Click(TObject *Sender)
{
