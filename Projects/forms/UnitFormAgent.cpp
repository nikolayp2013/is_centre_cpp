...
void __fastcall TFormAgent::SpeedButton9Click(TObject *Sender)
{
	Close();
}
//---------------------------------------------------------------------------

void __fastcall TFormAgent::SpeedButton5Click(TObject *Sender)
{
	FormAgentPrint = new TFormAgentPrint(this);
	FormAgentPrint->ShowModal();
	delete FormAgentPrint;
}
//---------------------------------------------------------------------------

void __fastcall TFormAgent::SpeedButton6Click(TObject *Sender)
{
	FormAgentFilter = new TFormAgentFilter(this);
	FormAgentFilter->ShowModal();
	delete FormAgentFilter;
}
//---------------------------------------------------------------------------

void __fastcall TFormAgent::SpeedButton7Click(TObject *Sender)
{
	FormAbonent = new TFormAbonent(this, MainConn);
	FormAbonent->ShowModal();
	delete FormAbonent;
}
//---------------------------------------------------------------------------

void __fastcall TFormAgent::SpeedButton8Click(TObject *Sender)
{
	FormAgentRole = new TFormAgentRole(this, MainConn);
	FormAgentRole->ShowModal();
	delete FormAgentRole;
}
//---------------------------------------------------------------------------
