...
TFormEditArendSell *FormEditArendSell;
...
void __fastcall TFormEditArendSell::FormCreate(TObject *Sender)
{
...
//---------------------------------------------------------------------------
__fastcall TFormEditArendSell::TFormEditArendSell(TComponent* Owner)
			: TForm(Owner)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormEditArendSell::ProcRefreshClient(TObject *Sender)
{
...
void __fastcall TFormEditArendSell::FormShow(TObject *Sender)
{
	//Район
	...
	// Срок (мес.)
	Srok_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Srok_DBEdit->DataField="SROK";
	// На длительный срок
	Swsrok_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Swsrok_DBCheckBox->DataField="SWSROK";
	// Мебель
	Furniture_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Furniture_DBCheckBox->DataField="FURNITURE";
	// Телевизор
	Tv_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Tv_DBCheckBox->DataField="TV";
	// Аудио
	Audio_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Audio_DBCheckBox->DataField="AUDIO";
	// Интернет
	Internet_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Internet_DBCheckBox->DataField="INTERNET";
	// Кабельное телевидиние
	Kabtv_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Kabtv_DBCheckBox->DataField="KABTV";
	// Холодильник
	Refrigerator_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Refrigerator_DBCheckBox->DataField="REFRIGERATOR";
	// Стиральная машина
	Washing_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Washing_DBCheckBox->DataField="WASHING";
	// Встроенная кухня
	Kitchen_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Kitchen_DBCheckBox->DataField="KITCHEN";
	// Кондиционер
	Conditioner_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Conditioner_DBCheckBox->DataField="CONDITIONER";
	// Стеклопакет
	Window_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Window_DBCheckBox->DataField="WINDOW";
	// Газовая колонка
	Gazkol_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Gazkol_DBCheckBox->DataField="GAZKOL";
	// Коммунальные платежи
	Kompay_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Kompay_DBCheckBox->DataField="KOMPAY";
	// Интернет платеж
	Internetpay_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Internetpay_DBCheckBox->DataField="INTERNETPAY";
	// Эл энергия
	Energy_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	...
	// Газ платеж
	Gazpay_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Gazpay_DBCheckBox->DataField="GAZPAY";
	// Кабельное платеж
	Kabtvpay_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Kabtvpay_DBCheckBox->DataField="KABTVPAY";
	// Телефон платеж
	Phonepay_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Phonepay_DBCheckBox->DataField="PHONEPAY";
	// Домофон
	Homephone_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Homephone_DBCheckBox->DataField="HOMEPHONE";
	// Соседей
...
void __fastcall TFormEditArendSell::PageControl1DrawTab(TCustomTabControl *Control, int TabIndex,
...
void __fastcall TFormEditArendSell::Streets_DBEditKeyUp(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditArendSell::Streets_DBLookupListBoxClick(TObject *Sender)
{
...
void __fastcall TFormEditArendSell::Streets_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditArendSell::Streets_DBEditExit(TObject *Sender)
{
...
void __fastcall TFormEditArendSell::Streets_DBLookupListBoxKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift)
{
	 if (Key==13) {
		if (Streets_DBLookupListBox->Top==98) {
...
void __fastcall TFormEditArendSell::Streets_DBLookupListBoxMouseUp(TObject *Sender, TMouseButton Button,
...
void __fastcall TFormEditArendSell::Streets_DBLookupListBoxExit(TObject *Sender)
{
	if (Streets_DBLookupListBox->Top==98) {
		Streets_DBEdit->DataSource->DataSet->FieldByName("STREET")->Value=
			Streets_DBLookupListBox->KeyValue;
...
void __fastcall TFormEditArendSell::Cross_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditArendSell::Cross_DBEditKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditArendSell::Cross_DBEditExit(TObject *Sender)
{
	if (!Streets_DBLookupListBox->Focused()){
		if (Cross_DBEdit->Text.Length()!=0) {
			Streets_DBEdit->DataSource->DataSet->FieldByName("CRSTREET")->Value=
...
void __fastcall TFormEditArendSell::OnApplicationMessage(TMsg & Msg, bool & Handled)
{
...
void __fastcall TFormEditArendSell::SpeedButton2Click(TObject *Sender)
{
    //Фиксация изменений
...
void __fastcall TFormEditArendSell::Button6Click(TObject *Sender)
{
	//FormGall = new TFormGall(FormEdit,MainForm->MainConn,OtherTransaction,MainForm->TabPricelist_Datasource_Main,MainTable);
	//FormGall->ShowModal();
	//delete FormGall;
}
//---------------------------------------------------------------------------

void __fastcall TFormEditArendSell::Button4Click(TObject *Sender)
{
...
void __fastcall TFormEditArendSell::SpeedButton1Click(TObject *Sender)
{
...
void __fastcall TFormEditArendSell::SpeedButton3Click(TObject *Sender)
{
    MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("CLIENT")->AsInteger=0;
	// Вызов процедуры обновления сведений о клиенте
	ProcRefreshClient(this);
...
void __fastcall TFormEditArendSell::Button5Click(TObject *Sender)
{
	// Кнопка назад
...
void __fastcall TFormEditArendSell::Button3Click(TObject *Sender)
{
	// Кнопка вперед
...
void __fastcall TFormEditArendSell::ProcSave(TObject *Sender)
{
    //Фиксация изменений
	MainForm->TabPricelist_Datasource_Main->DataSet->CheckBrowseMode();
	//Записать изменения в базу данных
...
void __fastcall TFormEditArendSell::RefreshAgent(TObject *Sender)
{
...
void __fastcall TFormEditArendSell::Agent_ComboBoxClick(TObject *Sender)
{
	 Agent_datasource->DataSet->Active=true;
	 Agent_datasource->DataSet->First();
...
void __fastcall TFormEditArendSell::Button1Click(TObject *Sender)
{
...
void __fastcall TFormEditArendSell::Button2Click(TObject *Sender)
{
...
void __fastcall TFormEditArendSell::Button7Click(TObject *Sender)
{
	MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("DATE_CH")->AsDateTime=Date();
	// Квартира/комната
	if (Typeflat1_RadioButton->Checked) {
		MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("TYPEFLAT")->AsInteger = 1;
	} else {
		MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("TYPEFLAT")->AsInteger = 2;
	}
	ProcSave(this);
