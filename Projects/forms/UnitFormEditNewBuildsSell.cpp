...
TFormEditNewBuildsSell *FormEditNewBuildsSell;
...
extern TIBTable * Table_History;
// Таблица со списком вариантов дверей
TIBTable * Table_Doors = NULL;
extern TIBTable * Table_Doors;
TDataSource * Doors_datasource = NULL;
extern TDataSource * Doors_datasource;
// Таблица со списком вариантов окон
TIBTable * Table_Windows = NULL;
extern TIBTable * Table_Windows;
TDataSource * Windows_datasource = NULL;
extern TDataSource * Windows_datasource;

void __fastcall TFormEditNewBuildsSell::FormCreate(TObject *Sender)
{
...
//---------------------------------------------------------------------------
__fastcall TFormEditNewBuildsSell::TFormEditNewBuildsSell(TComponent* Owner)
			: TForm(Owner)
{
	...
	//Таблица со списком вариантов дверей
	Table_Doors = new TIBTable(NULL);
	Table_Doors->Database=MainForm->MainConn;
	Table_Doors->Transaction=OtherTransaction;
	Table_Doors->TableName = "ITEMS";
	Table_Doors->Filter="RAZDEL=30";
	Table_Doors->Filtered=TRUE;
	Table_Doors->Active = TRUE;
	Doors_datasource = new TDataSource(NULL);
	Doors_datasource->DataSet=Table_Doors;
	Doors_datasource->DataSet->Last();
	Doors_datasource->DataSet->First();
	//Таблица со списком вариантов окон
	Table_Windows = new TIBTable(NULL);
	Table_Windows->Database=MainForm->MainConn;
	Table_Windows->Transaction=OtherTransaction;
	Table_Windows->TableName = "ITEMS";
	Table_Windows->Filter="RAZDEL=29";
	Table_Windows->Filtered=TRUE;
	Table_Windows->Active = TRUE;
	Windows_datasource = new TDataSource(NULL);
	Windows_datasource->DataSet=Table_Windows;
	Windows_datasource->DataSet->Last();
	Windows_datasource->DataSet->First();
	//Таблица со списком договоров
	...
	Table_Typehouse->Filter="RAZDEL=27";
	...
	Table_Swphone->Filter="RAZDEL=32";
	...
	Table_Nodesan->Filter="RAZDEL=31";
	...
	Table_Varswap->Filter="RAZDEL=28";
...
//---------------------------------------------------------------------------
void __fastcall TFormEditNewBuildsSell::ProcRefreshClient(TObject *Sender)
{
...
void __fastcall TFormEditNewBuildsSell::FormShow(TObject *Sender)
{
	//Район
	...
	// Лифтов
	Lift_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Lift_DBEdit->DataField="LIFT";
	// Готвность
	Ready_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Ready_DBEdit->DataField="READY";
	// Подъездов
	Gates_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Gates_DBEdit->DataField="GATES";
	// Квартир
	Flats_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Flats_DBEdit->DataField="FLATS";
	// Материал стен
	Stuffwal_DBLookupComboBoxCentre->ListSource=Stuffwall_datasource;
	Stuffwal_DBLookupComboBoxCentre->ListField="FULLNAME";
	Stuffwal_DBLookupComboBoxCentre->KeyField="CODE";
	Stuffwal_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Stuffwal_DBLookupComboBoxCentre->DataField="STUFFWALL";
	// Отделка
	State_DBLookupComboBoxCentre->ListSource=Typehouse_datasource;
	...
	// Стены
	Walls_DBLookupComboBoxCentre->ListSource=State_datasource;
	Walls_DBLookupComboBoxCentre->ListField="FULLNAME";
	Walls_DBLookupComboBoxCentre->KeyField="CODE";
	Walls_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Walls_DBLookupComboBoxCentre->DataField="WALLS";
	// Пол
	Floor_DBLookupComboBoxCentre->ListSource=Varswap_datasource;
	Floor_DBLookupComboBoxCentre->ListField="FULLNAME";
	Floor_DBLookupComboBoxCentre->KeyField="CODE";
	Floor_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Floor_DBLookupComboBoxCentre->DataField="FLOOR";
	// Плита
	Plate_DBLookupComboBoxCentre->ListSource=Swphone_datasource;
	Plate_DBLookupComboBoxCentre->ListField="FULLNAME";
	Plate_DBLookupComboBoxCentre->KeyField="CODE";
	Plate_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Plate_DBLookupComboBoxCentre->DataField="PLATE";
	// Сан. оборудование
	Nodesan_DBLookupComboBoxCentre->ListSource=Nodesan_datasource;
	Nodesan_DBLookupComboBoxCentre->ListField="FULLNAME";
	Nodesan_DBLookupComboBoxCentre->KeyField="CODE";
	Nodesan_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Nodesan_DBLookupComboBoxCentre->DataField="NODESAN";
	// Двери
	Doors_DBLookupComboBoxCentre->ListSource=Doors_datasource;
	Doors_DBLookupComboBoxCentre->ListField="FULLNAME";
	Doors_DBLookupComboBoxCentre->KeyField="CODE";
	Doors_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Doors_DBLookupComboBoxCentre->DataField="DOORS";
	// Окна
	Windows_DBLookupComboBoxCentre->ListSource=Windows_datasource;
	Windows_DBLookupComboBoxCentre->ListField="FULLNAME";
	Windows_DBLookupComboBoxCentre->KeyField="CODE";
	Windows_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Windows_DBLookupComboBoxCentre->DataField="WINDOWS";
	// Квартал
	Quarter_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Quarter_DBEdit->DataField="QUARTER";
	// Первоначальный взнос
	Firstpay_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Firstpay_DBEdit->DataField="FIRSTPAY";
}
//---------------------------------------------------------------------------


void __fastcall TFormEditNewBuildsSell::PageControl1DrawTab(TCustomTabControl *Control, int TabIndex,
...
void __fastcall TFormEditNewBuildsSell::Streets_DBEditKeyUp(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditNewBuildsSell::Streets_DBLookupListBoxClick(TObject *Sender)
{
...
void __fastcall TFormEditNewBuildsSell::Streets_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditNewBuildsSell::Streets_DBEditExit(TObject *Sender)
{
...
void __fastcall TFormEditNewBuildsSell::Streets_DBLookupListBoxKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift)
{
	 if (Key==13) {
		if (Streets_DBLookupListBox->Top==98) {
...
void __fastcall TFormEditNewBuildsSell::Streets_DBLookupListBoxMouseUp(TObject *Sender, TMouseButton Button,
...
void __fastcall TFormEditNewBuildsSell::Streets_DBLookupListBoxExit(TObject *Sender)
{
	if (Streets_DBLookupListBox->Top==98) {
		Streets_DBEdit->DataSource->DataSet->FieldByName("STREET")->Value=
			Streets_DBLookupListBox->KeyValue;
...
void __fastcall TFormEditNewBuildsSell::Cross_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditNewBuildsSell::Cross_DBEditKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditNewBuildsSell::Cross_DBEditExit(TObject *Sender)
{
	if (!Streets_DBLookupListBox->Focused()){
		if (Cross_DBEdit->Text.Length()!=0) {
			Streets_DBEdit->DataSource->DataSet->FieldByName("CRSTREET")->Value=
...
void __fastcall TFormEditNewBuildsSell::OnApplicationMessage(TMsg & Msg, bool & Handled)
{
...
void __fastcall TFormEditNewBuildsSell::SpeedButton2Click(TObject *Sender)
{
    //Фиксация изменений
...
void __fastcall TFormEditNewBuildsSell::Button6Click(TObject *Sender)
{
...
void __fastcall TFormEditNewBuildsSell::Button4Click(TObject *Sender)
{
...
void __fastcall TFormEditNewBuildsSell::SpeedButton1Click(TObject *Sender)
{
...
void __fastcall TFormEditNewBuildsSell::SpeedButton3Click(TObject *Sender)
{
    MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("CLIENT")->AsInteger=0;
	// Вызов процедуры обновления сведений о клиенте
	ProcRefreshClient(this);
...
void __fastcall TFormEditNewBuildsSell::Button5Click(TObject *Sender)
{
	// Кнопка назад
...
void __fastcall TFormEditNewBuildsSell::Button3Click(TObject *Sender)
{
	// Кнопка вперед
...
void __fastcall TFormEditNewBuildsSell::ProcSave(TObject *Sender)
{
    //Фиксация изменений
	MainForm->TabPricelist_Datasource_Main->DataSet->CheckBrowseMode();
	//Записать изменения в базу данных
...
void __fastcall TFormEditNewBuildsSell::RefreshAgent(TObject *Sender)
{
...
void __fastcall TFormEditNewBuildsSell::Agent_ComboBoxClick(TObject *Sender)
{
	 Agent_datasource->DataSet->Active=true;
	 Agent_datasource->DataSet->First();
...
void __fastcall TFormEditNewBuildsSell::Button1Click(TObject *Sender)
{
...
void __fastcall TFormEditNewBuildsSell::Button2Click(TObject *Sender)
{
...
void __fastcall TFormEditNewBuildsSell::Button7Click(TObject *Sender)
{
