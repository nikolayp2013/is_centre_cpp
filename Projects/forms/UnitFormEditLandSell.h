...
#ifndef UnitFormEditLandSellH
#define UnitFormEditLandSellH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
class TFormEditLandSell : public TForm
{
__published:	// IDE-managed Components
	...
	TLabel *Label59;
	TLabel *Label60;
	TDBLookupComboBoxCentre *Landstate_DBLookupComboBoxCentre;
	...
	TDBLookupComboBoxCentre *Houseowner_DBLookupComboBoxCentre;
	TDBLookupComboBoxCentre *Writeowner_DBLookupComboBoxCentre;
	...
	TLabel *Label63;
	TLabel *Label64;
	TDBLookupComboBoxCentre *Purposeuse_DBLookupComboBoxCentre;
	TLabel *Label66;
	TShape *Shape11;
	TLabel *Label67;
	TDBCheckBox *Bound_DBCheckBox;
	TDBCheckBox *Doc_DBCheckBox;
	TDBEdit *Zone_DBEdit;
	TDBEdit *Wateradd_DBEdit;
...
public:		// User declarations
	__fastcall TFormEditLandSell(TComponent* Owner);
...
//};
//---------------------------------------------------------------------------
extern PACKAGE TFormEditLandSell *FormEditLandSell;
//---------------------------------------------------------------------------
#endif
