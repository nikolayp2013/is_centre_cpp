	...
	: TForm(Owner)
{
	...
	//Создать табличку параметры фильтра
...
{
	// Помощь
	AnsiString ds = "Вводите поля, которые по вашему мнению, могут присутствовать в доп. информации у объектов-долевок...\n"
			"Вы можете ввести как текст, так и диапазон цифровых значений, например: 2007..2010";
	MessageBox(NULL,ds.c_str(),"Информация",MB_OK | MB_TOPMOST | MB_ICONINFORMATION);
}
//---------------------------------------------------------------------------
