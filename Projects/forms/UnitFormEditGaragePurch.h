...
#ifndef UnitFormEditGaragePurchH
#define UnitFormEditGaragePurchH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TFormEditGaragePurch : public TForm
{
__published:	// IDE-managed Components
	...
	TButton *Button12;
	TButton *Button13;
	TDBEdit *Formpurch_DBEdit;
	TDBEdit *Realstate_DBEdit;
	...
	TDBCheckBox *Power380_DBCheckBox;
	TDBCheckBox *Hole_DBCheckBox;
	TDBCheckBox *Securety_DBCheckBox;
	TDBCheckBox *Power220_DBCheckBox;
	TDBCheckBox *Power12_DBCheckBox;
	TLabel *Label7;
	TDBEdit *Lengarage_DBEdit;
	TLabel *Label6;
	TDBEdit *Widthgarage_DBEdit;
	TLabel *Label11;
	TLabel *Label12;
	TLabel *Label16;
	TLabel *Label17;
...
public:		// User declarations
	__fastcall TFormEditGaragePurch(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFormEditGaragePurch *FormEditGaragePurch;
//---------------------------------------------------------------------------
#endif
