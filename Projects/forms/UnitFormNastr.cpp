	...
	: TForm(Owner)
{
	...
	//Создать табличку  с разделами прайс-листа
	...
	DBPath->Text=IniSer->ReadString("ServerFB","DBPath","");
}
//---------------------------------------------------------------------------
...
void __fastcall TFormNastr::Button1Click(TObject *Sender)
{
	...
	IniSer->WriteString("ServerFB","DBPath",DBPath->Text);
	Close();
}
//---------------------------------------------------------------------------
...
void __fastcall TFormNastr::Button3Click(TObject *Sender)
{
	if (OpenDialog1->Execute()) {
		...
		DBPath->Text = OpenDialog1->FileName;
	}
}
//---------------------------------------------------------------------------
