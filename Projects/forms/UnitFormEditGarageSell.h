...
#ifndef UnitFormEditGarageSellH
#define UnitFormEditGarageSellH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
class TFormEditGarageSell : public TForm
{
__published:	// IDE-managed Components
	...
	TDBLookupComboBoxCentre *Formsell_DBLookupComboBoxCentre;
	TShape *Shape7;
	TShape *Shape16;
	TShape *Shape6;
	TLabel *Label16;
	...
	TDBEdit *Hightgate_DBEdit;
	TLabel *Label65;
	TShape *Shape10;
	TShape *Shape15;
	TLabel *Label76;
	TLabel *Label77;
	TDBEdit *Fromtransp_DBEdit;
	TDBLookupComboBoxCentre *Floor_DBLookupComboBoxCentre;
	TDBLookupComboBoxCentre *Roof_DBLookupComboBoxCentre;
	TDBLookupComboBoxCentre *Gate_DBLookupComboBoxCentre;
	TDBCheckBox *Viewhole_DBCheckBox;
	TDBCheckBox *Hole_DBCheckBox;
	TDBCheckBox *Security_DBCheckBox;
	TDBCheckBox *DBCheckBox4;
	TDBCheckBox *Energy380_DBCheckBox;
	TDBCheckBox *Energy220_DBCheckBox;
	TDBCheckBox *Energy12_DBCheckBox;
	TDBCheckBox *Heating_DBCheckBox;
	TLabel *Label11;
	TDBLookupComboBoxCentre *Variant_DBLookComb;
	TDBLookupComboBoxCentre *Stuffwall_DBLookComb;
	TDBCheckBox *Build_DBCheckBox;
...
public:		// User declarations
	__fastcall TFormEditGarageSell(TComponent* Owner);
...
//};
//---------------------------------------------------------------------------
extern PACKAGE TFormEditGarageSell *FormEditGarageSell;
//---------------------------------------------------------------------------
#endif
