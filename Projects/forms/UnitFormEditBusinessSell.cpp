...
TFormEditBusinessSell *FormEditBusinessSell;
...
void __fastcall TFormEditBusinessSell::FormCreate(TObject *Sender)
{
...
//---------------------------------------------------------------------------
__fastcall TFormEditBusinessSell::TFormEditBusinessSell(TComponent* Owner)
			: TForm(Owner)
{
	...
	Table_Items_10->Filter="RAZDEL=92";
	...
	Table_Variant->Filter="RAZDEL=95";
	...
	Table_Typehouse->Filter="RAZDEL=93";
	...
	//Таблица причина продажи бизнеса
	...
	Table_Stuffwall->Filter="RAZDEL=94";
	...
	//Таблица форма собственности на землю
...
//---------------------------------------------------------------------------
void __fastcall TFormEditBusinessSell::ProcRefreshClient(TObject *Sender)
{
...
void __fastcall TFormEditBusinessSell::FormShow(TObject *Sender)
{
	//Район
	...
	Buisnessname_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Buisnessname_DBEdit->DataField="BUISNESSNAME";
	// Тип предложения
	Typesell_DBLookupComboBoxCentre->ListSource=mRegion_datasource;
	Typesell_DBLookupComboBoxCentre->ListField="FULLNAME";
	Typesell_DBLookupComboBoxCentre->KeyField="ID";
	Typesell_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Typesell_DBLookupComboBoxCentre->DataField="TYPESELL";
	// Форма собственности
	Formowner_DBLookupComboBoxCentre->ListSource=Variant_datasource;
	Formowner_DBLookupComboBoxCentre->ListField="FULLNAME";
	Formowner_DBLookupComboBoxCentre->KeyField="ID";
	...
	// Вид деятельности
	Doing_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Doing_DBEdit->DataField="DOING";
	// Доля покупки
	Partpay_DBLookupComboBoxCentre->ListSource=Typehouse_datasource;
	Partpay_DBLookupComboBoxCentre->ListField="FULLNAME";
	Partpay_DBLookupComboBoxCentre->KeyField="ID";
	Partpay_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Partpay_DBLookupComboBoxCentre->DataField="PARTPAY";
	// Счет в банке
	Bankschet_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Bankschet_DBCheckBox->DataField="BANKSCHET";
	// Причина продажи бизнеса
	Causesell_DBLookupComboBoxCentre->ListSource=Stuffwall_datasource;
	Causesell_DBLookupComboBoxCentre->ListField="FULLNAME";
	Causesell_DBLookupComboBoxCentre->KeyField="ID";
	Causesell_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Causesell_DBLookupComboBoxCentre->DataField="CAUSESELL";
	// Величина собственного капитала
	Ownkapital_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Ownkapital_DBEdit->DataField="OWNKAPITAL";
	// Стоимость активов
	Activprice_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Activprice_DBEdit->DataField="ACTIVPRICE";
	// Величина заемного капитала
	Zaemkapital_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Zaemkapital_DBEdit->DataField="ZAEMKAPITAL";
	// Дебиторская задолженность
	Debdolg_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Debdolg_DBEdit->DataField="DEBDOLG";
	// Кредиторская задолженность
	Kreddolg_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Kreddolg_DBEdit->DataField="KREDDOLG";
	// Срок существования бизнеса
	Buisnessold_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Buisnessold_DBEdit->DataField="BUISNESSOLD";
	// Срок окупаемости бизнеса
	Okupaemost_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Okupaemost_DBEdit->DataField="OKUPAEMOST";
	// Финансовые показатели
	Finance_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Finance_DBCheckBox->DataField="FINANCE";
	// Численность персонала
	Amountpers_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Amountpers_DBEdit->DataField="AMOUNTPERS";
	// ФЗП (мес.)
	Zp_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Zp_DBEdit->DataField="ZP";
	// Местоположение
	Place_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Place_DBEdit->DataField="PLACE";
	// Форма собственности на землю
	Ownerland_DBLookupComboBoxCentre->ListSource=State_datasource;
	Ownerland_DBLookupComboBoxCentre->ListField="FULLNAME";
	Ownerland_DBLookupComboBoxCentre->KeyField="ID";
	Ownerland_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Ownerland_DBLookupComboBoxCentre->DataField="OWNERLAND";
	// Земля
	Land_DBMemo->DataSource=MainForm->TabPricelist_Datasource_Main;
	Land_DBMemo->DataField="LAND";
	// Сооружения, помещения
	Placement_DBMemo->DataSource=MainForm->TabPricelist_Datasource_Main;
	Placement_DBMemo->DataField="PLACEMENT";
	// Описание нематериальных активов
	Nemataktiv_DBMemo->DataSource=MainForm->TabPricelist_Datasource_Main;
	Nemataktiv_DBMemo->DataField="NEMATAKTIV";
	// Описание средств производства, оборудования
	Equipment_DBMemo->DataSource=MainForm->TabPricelist_Datasource_Main;
	Equipment_DBMemo->DataField="EQUIPMENT";
	// Особые характеристики
	Spechar_DBMemo->DataSource=MainForm->TabPricelist_Datasource_Main;
	Spechar_DBMemo->DataField="SPECHAR";
	// Перспективы развития
	Perspectiv_DBMemo->DataSource=MainForm->TabPricelist_Datasource_Main;
	Perspectiv_DBMemo->DataField="PERSPECTIV";
	// Договор
	...
	// Номер договора
	Contractnum_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Contractnum_DBEdit->DataField="CONTRACTNUM";
	// Дата начала
	Begcont_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Begcont_DBEdit->DataField="BEGCONT";
	// Датаокончания
	Endcont_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Endcont_DBEdit->DataField="ENDCONT";
}
//---------------------------------------------------------------------------


void __fastcall TFormEditBusinessSell::PageControl1DrawTab(TCustomTabControl *Control, int TabIndex,
...
void __fastcall TFormEditBusinessSell::Streets_DBEditKeyUp(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditBusinessSell::Streets_DBLookupListBoxClick(TObject *Sender)
{
...
void __fastcall TFormEditBusinessSell::Streets_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditBusinessSell::Streets_DBEditExit(TObject *Sender)
{
...
void __fastcall TFormEditBusinessSell::Streets_DBLookupListBoxKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift)
{
	 if (Key==13) {
		/*if (Streets_DBLookupListBox->Top==98) {
...
void __fastcall TFormEditBusinessSell::Streets_DBLookupListBoxMouseUp(TObject *Sender, TMouseButton Button,
...
void __fastcall TFormEditBusinessSell::Streets_DBLookupListBoxExit(TObject *Sender)
{
	if (Streets_DBLookupListBox->Top==98) {
		Streets_DBEdit->DataSource->DataSet->FieldByName("STREET")->Value=
			Streets_DBLookupListBox->KeyValue;
...
void __fastcall TFormEditBusinessSell::Cross_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditBusinessSell::Cross_DBEditKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditBusinessSell::Cross_DBEditExit(TObject *Sender)
{
	if (!Streets_DBLookupListBox->Focused()){
		if (Cross_DBEdit->Text.Length()!=0) {
			Streets_DBEdit->DataSource->DataSet->FieldByName("CRSTREET")->Value=
...
void __fastcall TFormEditBusinessSell::OnApplicationMessage(TMsg & Msg, bool & Handled)
{
...
void __fastcall TFormEditBusinessSell::SpeedButton2Click(TObject *Sender)
{
    //Фиксация изменений
...
void __fastcall TFormEditBusinessSell::Button6Click(TObject *Sender)
{
...
void __fastcall TFormEditBusinessSell::Button4Click(TObject *Sender)
{
...
void __fastcall TFormEditBusinessSell::SpeedButton1Click(TObject *Sender)
{
...
void __fastcall TFormEditBusinessSell::SpeedButton3Click(TObject *Sender)
{
    MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("CLIENT")->AsInteger=0;
	// Вызов процедуры обновления сведений о клиенте
	ProcRefreshClient(this);
...
void __fastcall TFormEditBusinessSell::Button5Click(TObject *Sender)
{
	// Кнопка назад
...
void __fastcall TFormEditBusinessSell::Button3Click(TObject *Sender)
{
	// Кнопка вперед
...
void __fastcall TFormEditBusinessSell::ProcSave(TObject *Sender)
{
    //Фиксация изменений
	MainForm->TabPricelist_Datasource_Main->DataSet->CheckBrowseMode();
	//Записать изменения в базу данных
...
void __fastcall TFormEditBusinessSell::RefreshAgent(TObject *Sender)
{
...
void __fastcall TFormEditBusinessSell::Agent_ComboBoxClick(TObject *Sender)
{
	 Agent_datasource->DataSet->Active=true;
	 Agent_datasource->DataSet->First();
...
void __fastcall TFormEditBusinessSell::Button1Click(TObject *Sender)
{
...
void __fastcall TFormEditBusinessSell::Button2Click(TObject *Sender)
{
...
void __fastcall TFormEditBusinessSell::Button7Click(TObject *Sender)
{
