...
#pragma resource "*.dfm"
TFormFilterAddRooms *FormFilterAddRooms;
int leftside;
extern int leftside;
...
//---------------------------------------------------------------------------
__fastcall TFormFilterAddRooms::TFormFilterAddRooms(TComponent* Owner, TIBDatabase * MainConn_loc)
	: TForm(Owner)
{
...
void __fastcall TFormFilterAddRooms::StreetFilter(TObject *Sender)
{
...
void __fastcall TFormFilterAddRooms::SpeedButton9Click(TObject *Sender)
{
    strFilterAdd = "";
	Close();
}
...
void __fastcall TFormFilterAddRooms::SpeedButton7Click(TObject *Sender)
{
	strFilterAdd = "";
...
void __fastcall TFormFilterAddRooms::FormResize(TObject *Sender)
{
	//FormFilterAdd->Left = leftside - FormFilterAdd->Width;
}
//---------------------------------------------------------------------------

void __fastcall TFormFilterAddRooms::FormShow(TObject *Sender)
{
...
void __fastcall TFormFilterAddRooms::Region_ComboBoxClick(TObject *Sender)
{
	StreetFilter(this);
	Table_Streets->First();
...
void __fastcall TFormFilterAddRooms::Street_EditKeyUp(TObject *Sender, WORD &Key, TShiftState Shift)
...
void __fastcall TFormFilterAddRooms::SpeedButton1Click(TObject *Sender)
{
	// Добавить улицу
...
void __fastcall TFormFilterAddRooms::SpeedButton2Click(TObject *Sender)
{
...
void __fastcall TFormFilterAddRooms::SpeedButton3Click(TObject *Sender)
{
...
void __fastcall TFormFilterAddRooms::SpeedButton6Click(TObject *Sender)
{
...
void __fastcall TFormFilterAddRooms::SpeedButton5Click(TObject *Sender)
{
	Livearea1_Edit->Text = "";
	Livearea2_Edit->Text = "";
}
...
void __fastcall TFormFilterAddRooms::SpeedButton4Click(TObject *Sender)
{
...
void __fastcall TFormFilterAddRooms::SpeedButton8Click(TObject *Sender)
{
	// Параметры фильтра
