...
TFormEditGarageSell *FormEditGarageSell;
...
// Форма предложения
TIBTable * Table_Formsell = NULL;
extern TIBTable * Table_Formsell;
TDataSource * Formsell_Datasource =NULL;
extern TDataSource * Formsell_Datasource;
// Пол
TIBTable * Table_Floor = NULL;
extern TIBTable * Table_Floor;
TDataSource * Floor_Datasource =NULL;
extern TDataSource * Floor_Datasource;
// Крыша
TIBTable * Table_Roof = NULL;
extern TIBTable * Table_Roof;
TDataSource * Roof_Datasource =NULL;
extern TDataSource * Roof_Datasource;
// Подъезд
TIBTable * Table_Gate = NULL;
extern TIBTable * Table_Gate;
TDataSource * Gate_Datasource =NULL;
extern TDataSource * Gate_Datasource;
void __fastcall TFormEditGarageSell::FormCreate(TObject *Sender)
{
...
//---------------------------------------------------------------------------
__fastcall TFormEditGarageSell::TFormEditGarageSell(TComponent* Owner)
			: TForm(Owner)
{
	...
	Table_Formowner->Filter="RAZDEL=17";
	...
	// Форма предложения
	Table_Formsell = new TIBTable(NULL);
	Table_Formsell->Database=MainForm->MainConn;
	Table_Formsell->Transaction=OtherTransaction;
	Table_Formsell->TableName = "ITEMS";
	Table_Formsell->Filter="RAZDEL=18";
	Table_Formsell->Filtered=TRUE;
	Table_Formsell->Active = TRUE;
	Table_Formsell->FetchAll();
	Formsell_Datasource = new TDataSource(NULL);
	Formsell_Datasource->DataSet=Table_Formsell;
	// Пол
	Table_Floor = new TIBTable(NULL);
	Table_Floor->Database=MainForm->MainConn;
	Table_Floor->Transaction=OtherTransaction;
	Table_Floor->TableName = "ITEMS";
	Table_Floor->Filter="RAZDEL=38";
	Table_Floor->Filtered=TRUE;
	Table_Floor->Active = TRUE;
	Table_Floor->FetchAll();
	Floor_Datasource = new TDataSource(NULL);
	Floor_Datasource->DataSet=Table_Floor;
	// Крыша
	Table_Roof = new TIBTable(NULL);
	Table_Roof->Database=MainForm->MainConn;
	Table_Roof->Transaction=OtherTransaction;
	Table_Roof->TableName = "ITEMS";
	Table_Roof->Filter="RAZDEL=39";
	Table_Roof->Filtered=TRUE;
	Table_Roof->Active = TRUE;
	Table_Roof->FetchAll();
	Roof_Datasource = new TDataSource(NULL);
	Roof_Datasource->DataSet=Table_Roof;
	// Подъезд
	Table_Gate = new TIBTable(NULL);
	Table_Gate->Database=MainForm->MainConn;
	Table_Gate->Transaction=OtherTransaction;
	Table_Gate->TableName = "ITEMS";
	Table_Gate->Filter="RAZDEL=40";
	Table_Gate->Filtered=TRUE;
	Table_Gate->Active = TRUE;
	Table_Gate->FetchAll();
	Gate_Datasource = new TDataSource(NULL);
	Gate_Datasource->DataSet=Table_Gate;
...
//---------------------------------------------------------------------------
void __fastcall TFormEditGarageSell::ProcRefreshClient(TObject *Sender)
{
...
void __fastcall TFormEditGarageSell::FormShow(TObject *Sender)
{
	//Район
	...
	// Форма предложения
	Formsell_DBLookupComboBoxCentre->ListSource=Formsell_Datasource;
	Formsell_DBLookupComboBoxCentre->ListField="FULLNAME";
	Formsell_DBLookupComboBoxCentre->KeyField="CODE";
	Formsell_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Formsell_DBLookupComboBoxCentre->DataField="FORMSELL";
	// Размер гаража
	...
	// Высота ворот
	Hightgate_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Hightgate_DBEdit->DataField="HIGHTGATE";
	// Пол
	Floor_DBLookupComboBoxCentre->ListSource=Floor_Datasource;
	...
	// Крыша
	Roof_DBLookupComboBoxCentre->ListSource=Roof_Datasource;
	Roof_DBLookupComboBoxCentre->ListField="FULLNAME";
	Roof_DBLookupComboBoxCentre->KeyField="CODE";
	Roof_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Roof_DBLookupComboBoxCentre->DataField="ROOF";
	// Подъезд
	Gate_DBLookupComboBoxCentre->ListSource=Gate_Datasource;
	Gate_DBLookupComboBoxCentre->ListField="FULLNAME";
	Gate_DBLookupComboBoxCentre->KeyField="CODE";
	Gate_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Gate_DBLookupComboBoxCentre->DataField="GATE";
	// Смотровая яма
	...
	// Обустройство
	Build_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Build_DBCheckBox->DataField="BUILD";
	// Электричество 380 вольт
	Energy380_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Energy380_DBCheckBox->DataField="ENERGY380";
	// Электричество 220 вольт
	Energy220_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Energy220_DBCheckBox->DataField="ENERGY220";
	// Электричество 12 вольт
	Energy12_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Energy12_DBCheckBox->DataField="ENERGY12";
	// Отопление
	Heating_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Heating_DBCheckBox->DataField="HEATING";
	// Расстояние до транспорта
	Fromtransp_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Fromtransp_DBEdit->DataField="FROMTRANSP";
}
//---------------------------------------------------------------------------


void __fastcall TFormEditGarageSell::PageControl1DrawTab(TCustomTabControl *Control, int TabIndex,
...
void __fastcall TFormEditGarageSell::Streets_DBEditKeyUp(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditGarageSell::Streets_DBLookupListBoxClick(TObject *Sender)
{
...
void __fastcall TFormEditGarageSell::Streets_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditGarageSell::Streets_DBEditExit(TObject *Sender)
{
...
void __fastcall TFormEditGarageSell::Streets_DBLookupListBoxKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift)
{
	 if (Key==13) {
		if (Streets_DBLookupListBox->Top==98) {
...
void __fastcall TFormEditGarageSell::Streets_DBLookupListBoxMouseUp(TObject *Sender, TMouseButton Button,
...
void __fastcall TFormEditGarageSell::Streets_DBLookupListBoxExit(TObject *Sender)
{
	if (Streets_DBLookupListBox->Top==98) {
		Streets_DBEdit->DataSource->DataSet->FieldByName("STREET")->Value=
			Streets_DBLookupListBox->KeyValue;
...
void __fastcall TFormEditGarageSell::Cross_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditGarageSell::Cross_DBEditKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditGarageSell::Cross_DBEditExit(TObject *Sender)
{
	if (!Streets_DBLookupListBox->Focused()){
		if (Cross_DBEdit->Text.Length()!=0) {
			Streets_DBEdit->DataSource->DataSet->FieldByName("CRSTREET")->Value=
...
void __fastcall TFormEditGarageSell::OnApplicationMessage(TMsg & Msg, bool & Handled)
{
...
void __fastcall TFormEditGarageSell::SpeedButton2Click(TObject *Sender)
{
    //Фиксация изменений
...
void __fastcall TFormEditGarageSell::Button6Click(TObject *Sender)
{
...
void __fastcall TFormEditGarageSell::Button4Click(TObject *Sender)
{
...
void __fastcall TFormEditGarageSell::SpeedButton1Click(TObject *Sender)
{
...
void __fastcall TFormEditGarageSell::SpeedButton3Click(TObject *Sender)
{
    MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("CLIENT")->AsInteger=0;
	// Вызов процедуры обновления сведений о клиенте
	ProcRefreshClient(this);
...
void __fastcall TFormEditGarageSell::Button5Click(TObject *Sender)
{
	// Кнопка назад
...
void __fastcall TFormEditGarageSell::Button3Click(TObject *Sender)
{
	// Кнопка вперед
...
void __fastcall TFormEditGarageSell::ProcSave(TObject *Sender)
{
    //Фиксация изменений
	MainForm->TabPricelist_Datasource_Main->DataSet->CheckBrowseMode();
	//Записать изменения в базу данных
...
void __fastcall TFormEditGarageSell::RefreshAgent(TObject *Sender)
{
...
void __fastcall TFormEditGarageSell::Agent_ComboBoxClick(TObject *Sender)
{
	 Agent_datasource->DataSet->Active=true;
	 Agent_datasource->DataSet->First();
...
void __fastcall TFormEditGarageSell::Button1Click(TObject *Sender)
{
...
void __fastcall TFormEditGarageSell::Button2Click(TObject *Sender)
{
...
void __fastcall TFormEditGarageSell::Button7Click(TObject *Sender)
{
