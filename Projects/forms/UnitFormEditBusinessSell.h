...
__published:	// IDE-managed Components
	...
	TLabel *Label49;
	TButton *Button2;
	TDBLookupComboBoxCentre *Typesell_DBLookupComboBoxCentre;
	TButton *Button3;
	TButton *Button4;
	TButton *Button5;
	TButton *Button6;
	...
	TLabel *Label19;
	TLabel *Label52;
	TDBEdit *Doing_DBEdit;
	TLabel *Label53;
	TLabel *Label54;
	TDBLookupComboBoxCentre *Partpay_DBLookupComboBoxCentre;
	...
	TLabel *Label57;
	TLabel *Label58;
	TDBEdit *Amountpers_DBEdit;
	TLabel *Label11;
	TDBLookupComboBoxCentre *Variant_DBLookComb;
	TLabel *Label64;
	TDBLookupComboBoxCentre *Ownerland_DBLookupComboBoxCentre;
	TLabel *Label66;
	TLabel *Label68;
	TDBEdit *Buisnessname_DBEdit;
	TDBCheckBox *Bankschet_DBCheckBox;
	TLabel *Label69;
	TDBLookupComboBoxCentre *Causesell_DBLookupComboBoxCentre;
	TLabel *Label70;
	TDBCheckBox *Finance_DBCheckBox;
	TLabel *Label71;
	TLabel *Label72;
	TDBEdit *Ownkapital_DBEdit;
	TLabel *Label73;
	TDBEdit *Activprice_DBEdit;
	TDBEdit *Zaemkapital_DBEdit;
	TLabel *Label74;
	TDBEdit *Debdolg_DBEdit;
	TLabel *Label75;
	TDBEdit *Kreddolg_DBEdit;
	TLabel *Label78;
	TShape *Shape17;
	TLabel *Label79;
	TLabel *Label80;
	TDBEdit *Buisnessold_DBEdit;
	TDBEdit *Okupaemost_DBEdit;
	TLabel *Label81;
	TDBEdit *Zp_DBEdit;
	TDBEdit *Place_DBEdit;
	TDBMemo *Placement_DBMemo;
	TLabel *Label1;
	TDBMemo *Nemataktiv_DBMemo;
	TLabel *Label9;
	TDBMemo *Equipment_DBMemo;
	TLabel *Label10;
	TDBMemo *Spechar_DBMemo;
	TLabel *Label35;
	TDBMemo *Perspectiv_DBMemo;
	TLabel *Label59;
	TShape *Shape9;
	TDBEdit *Contractnum_DBEdit;
	TLabel *Label60;
	TDBLookupComboBoxCentre *Contract_DBLookupComboBoxCentre;
	TLabel *Label61;
	TLabel *Label62;
	TDBEdit *Begcont_DBEdit;
	TLabel *Label63;
	TDBEdit *Endcont_DBEdit;
...
public:		// User declarations
	__fastcall TFormEditBusinessSell(TComponent* Owner);
