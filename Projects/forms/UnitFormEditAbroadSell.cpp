...
TFormEditAbroadSell *FormEditAbroadSell;
...
void __fastcall TFormEditAbroadSell::FormCreate(TObject *Sender)
{
...
//---------------------------------------------------------------------------
__fastcall TFormEditAbroadSell::TFormEditAbroadSell(TComponent* Owner)
			: TForm(Owner)
{
	...
	Table_Items_8->Filter="RAZDEL=96";
	...
	Table_Typehouse->Filter="RAZDEL=97";
	...
	Table_Stuffwall->Filter="RAZDEL=47";
...
//---------------------------------------------------------------------------
void __fastcall TFormEditAbroadSell::ProcRefreshClient(TObject *Sender)
{
...
void __fastcall TFormEditAbroadSell::FormShow(TObject *Sender)
{
	//Район
	...
	// Недвижимость
	Real_DBLookupComboBoxCentre->ListSource=Region_datasource;
	Real_DBLookupComboBoxCentre->ListField="FULLNAME";
	Real_DBLookupComboBoxCentre->KeyField="ID";
	Real_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Real_DBLookupComboBoxCentre->DataField="REAL";
	// Форма предложения
	...
	// Страна
	Country_DBLookupComboBoxCentre->ListSource=Typehouse_datasource;
	Country_DBLookupComboBoxCentre->ListField="FULLNAME";
	Country_DBLookupComboBoxCentre->KeyField="ID";
	Country_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	Country_DBLookupComboBoxCentre->DataField="COUNTRY";
	// Населенный пункт
	Town_DBEdit->DataSource=MainForm->TabPricelist_Datasource_Main;
	Town_DBEdit->DataField="TOWN";
	// Форма владения
	Formowner_DBLookupComboBoxCentre->ListSource=Stuffwall_datasource;
	...
	// Дополнительная информация по строению
	Addinfobuild_DBMemo->DataSource=MainForm->TabPricelist_Datasource_Main;
	Addinfobuild_DBMemo->DataField="ADDINFOBUILD";
	...
	// Дополнительная информация по земле
	Addinfoland_DBMemo->DataSource=MainForm->TabPricelist_Datasource_Main;
	Addinfoland_DBMemo->DataField="ADDINFOLAND";
}
//---------------------------------------------------------------------------


void __fastcall TFormEditAbroadSell::PageControl1DrawTab(TCustomTabControl *Control, int TabIndex,
...
void __fastcall TFormEditAbroadSell::Streets_DBEditKeyUp(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditAbroadSell::Streets_DBLookupListBoxClick(TObject *Sender)
{
...
void __fastcall TFormEditAbroadSell::Streets_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditAbroadSell::Streets_DBEditExit(TObject *Sender)
{
...
void __fastcall TFormEditAbroadSell::Streets_DBLookupListBoxKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift)
{
	 if (Key==13) {
		if (Streets_DBLookupListBox->Top==98) {
...
void __fastcall TFormEditAbroadSell::Streets_DBLookupListBoxMouseUp(TObject *Sender, TMouseButton Button,
...
void __fastcall TFormEditAbroadSell::Streets_DBLookupListBoxExit(TObject *Sender)
{
	if (Streets_DBLookupListBox->Top==98) {
		Streets_DBEdit->DataSource->DataSet->FieldByName("STREET")->Value=
			Streets_DBLookupListBox->KeyValue;
...
void __fastcall TFormEditAbroadSell::Cross_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditAbroadSell::Cross_DBEditKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditAbroadSell::Cross_DBEditExit(TObject *Sender)
{
	if (!Streets_DBLookupListBox->Focused()){
		if (Cross_DBEdit->Text.Length()!=0) {
			Streets_DBEdit->DataSource->DataSet->FieldByName("CRSTREET")->Value=
...
void __fastcall TFormEditAbroadSell::OnApplicationMessage(TMsg & Msg, bool & Handled)
{
...
void __fastcall TFormEditAbroadSell::SpeedButton2Click(TObject *Sender)
{
    //Фиксация изменений
...
void __fastcall TFormEditAbroadSell::Button6Click(TObject *Sender)
{
	//FormGall = new TFormGall(FormEdit,MainForm->MainConn,OtherTransaction,MainForm->TabPricelist_Datasource_Main,MainForm->MainTable);
	//FormGall->ShowModal();
	//delete FormGall;
}
//---------------------------------------------------------------------------

void __fastcall TFormEditAbroadSell::Button4Click(TObject *Sender)
{
...
void __fastcall TFormEditAbroadSell::SpeedButton1Click(TObject *Sender)
{
...
void __fastcall TFormEditAbroadSell::SpeedButton3Click(TObject *Sender)
{
    MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("CLIENT")->AsInteger=0;
	// Вызов процедуры обновления сведений о клиенте
	ProcRefreshClient(this);
...
void __fastcall TFormEditAbroadSell::Button5Click(TObject *Sender)
{
	// Кнопка назад
...
void __fastcall TFormEditAbroadSell::Button3Click(TObject *Sender)
{
	// Кнопка вперед
...
void __fastcall TFormEditAbroadSell::ProcSave(TObject *Sender)
{
    //Фиксация изменений
	MainForm->TabPricelist_Datasource_Main->DataSet->CheckBrowseMode();
	//Записать изменения в базу данных
...
void __fastcall TFormEditAbroadSell::RefreshAgent(TObject *Sender)
{
...
void __fastcall TFormEditAbroadSell::Agent_ComboBoxClick(TObject *Sender)
{
	 Agent_datasource->DataSet->Active=true;
	 Agent_datasource->DataSet->First();
...
void __fastcall TFormEditAbroadSell::Button1Click(TObject *Sender)
{
...
void __fastcall TFormEditAbroadSell::Button2Click(TObject *Sender)
{
...
void __fastcall TFormEditAbroadSell::Button7Click(TObject *Sender)
{
