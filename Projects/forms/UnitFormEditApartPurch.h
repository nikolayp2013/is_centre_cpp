...
#ifndef UnitFormEditApartPurchH
#define UnitFormEditApartPurchH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TFormEditApartPurch : public TForm
{
...
public:		// User declarations
	__fastcall TFormEditApartPurch(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFormEditApartPurch *FormEditApartPurch;
//---------------------------------------------------------------------------
#endif
