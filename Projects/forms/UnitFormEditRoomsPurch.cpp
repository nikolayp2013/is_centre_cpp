...
//---------------------------------------------------------------------------
__fastcall TFormEditRoomsPurch::TFormEditRoomsPurch(TComponent* Owner)
	: TForm(Owner)
{
	...
	// Комату / гостинку
	if (MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("IROOMS")->AsInteger==1) {
		Room_RadioButton->Checked = true;
	}
	if (MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("IROOMS")->AsInteger==2) {
...
void __fastcall TFormEditRoomsPurch::BitBtn1Click(TObject *Sender)
{
	...
	if (Room_RadioButton->Checked) {
		MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("IROOMS")->AsInteger=1;
	}
	if (Gost_RadioButton->Checked) {
		MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("IROOMS")->AsInteger=2;
	}
...
void __fastcall TFormEditRoomsPurch::FormActivate(TObject *Sender)
{
	// Квартиру
