...
__published:	// IDE-managed Components
	...
	TButton *Button11;
	TLabel *Label66;
	TDBLookupComboBoxCentre *Parking_DBLookupComboBoxCentre;
	TDBLookupComboBoxCentre *Commplace_DBLookupComboBoxCentre;
	TShape *Shape20;
...
public:		// User declarations
	__fastcall TFormEditCommercSell2(TComponent* Owner);
