...
#ifndef UnitFormEditCommercSell3H
#define UnitFormEditCommercSell3H
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
class TFormEditCommercSell3 : public TForm
{
__published:	// IDE-managed Components
	...
	TDBCheckBox *Equipment_DBCheckBox;
	TLabel *Label68;
	...
	TLabel *Label66;
	TLabel *Label67;
	TDBLookupComboBoxCentre *Placement_DBLookupComboBoxCentre;
	TDBLookupComboBoxCentre *Profile_DBLookupComboBoxCentre;
...
public:		// User declarations
	__fastcall TFormEditCommercSell3(TComponent* Owner);
...
//};
//---------------------------------------------------------------------------
extern PACKAGE TFormEditCommercSell3 *FormEditCommercSell3;
//---------------------------------------------------------------------------
#endif
