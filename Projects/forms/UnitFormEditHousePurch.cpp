...
// Таблица со списком типов недвижимости
...
// Таблица со списком форм спроса
...
//---------------------------------------------------------------------------
__fastcall TFormEditHousePurch::TFormEditHousePurch(TComponent* Owner)
	: TForm(Owner)
{
	...
	//Создать табличку со списком типов недвижимости
	...
	//Создать табличку со списком форм спроса
	Table_Formpurch = new TIBTable(NULL);
	Table_Formpurch->Database=MainForm->MainConn;
	Table_Formpurch->Transaction=OtherTransaction;
...
void __fastcall TFormEditHousePurch::FormActivate(TObject *Sender)
{
	// Квартиру
	...
	Formpurch_DBLookupComboBoxCentre->DataSource=MainForm->TabPricelist_Datasource_Main;
	...
	// Телефон
	Phone_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	...
	// Наличие гаража
	Garage_DBCheckBox->DataSource=MainForm->TabPricelist_Datasource_Main;
	Garage_DBCheckBox->DataField="GARAGE";
	// Ориентир
	Marker_DBMemo->DataSource=MainForm->TabPricelist_Datasource_Main;
