...
TFormEditCommercSell1 *FormEditCommercSell1;
...
void __fastcall TFormEditCommercSell1::FormCreate(TObject *Sender)
{
...
//---------------------------------------------------------------------------
__fastcall TFormEditCommercSell1::TFormEditCommercSell1(TComponent* Owner)
			: TForm(Owner)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormEditCommercSell1::ProcRefreshClient(TObject *Sender)
{
...
void __fastcall TFormEditCommercSell1::FormShow(TObject *Sender)
{
	//Район
...
void __fastcall TFormEditCommercSell1::PageControl1DrawTab(TCustomTabControl *Control, int TabIndex,
...
void __fastcall TFormEditCommercSell1::Streets_DBEditKeyUp(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditCommercSell1::Streets_DBLookupListBoxClick(TObject *Sender)
{
...
void __fastcall TFormEditCommercSell1::Streets_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditCommercSell1::Streets_DBEditExit(TObject *Sender)
{
...
void __fastcall TFormEditCommercSell1::Streets_DBLookupListBoxKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift)
{
	 if (Key==13) {
		if (Streets_DBLookupListBox->Top==98) {
...
void __fastcall TFormEditCommercSell1::Streets_DBLookupListBoxMouseUp(TObject *Sender, TMouseButton Button,
...
void __fastcall TFormEditCommercSell1::Streets_DBLookupListBoxExit(TObject *Sender)
{
	if (Streets_DBLookupListBox->Top==98) {
		Streets_DBEdit->DataSource->DataSet->FieldByName("STREET")->Value=
			Streets_DBLookupListBox->KeyValue;
...
void __fastcall TFormEditCommercSell1::Cross_DBEditEnter(TObject *Sender)
{
...
void __fastcall TFormEditCommercSell1::Cross_DBEditKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
void __fastcall TFormEditCommercSell1::Cross_DBEditExit(TObject *Sender)
{
	if (!Streets_DBLookupListBox->Focused()){
		if (Cross_DBEdit->Text.Length()!=0) {
			Streets_DBEdit->DataSource->DataSet->FieldByName("CRSTREET")->Value=
...
void __fastcall TFormEditCommercSell1::OnApplicationMessage(TMsg & Msg, bool & Handled)
{
...
void __fastcall TFormEditCommercSell1::SpeedButton2Click(TObject *Sender)
{
    //Фиксация изменений
...
void __fastcall TFormEditCommercSell1::Button6Click(TObject *Sender)
{
...
void __fastcall TFormEditCommercSell1::Button4Click(TObject *Sender)
{
...
void __fastcall TFormEditCommercSell1::SpeedButton1Click(TObject *Sender)
{
...
void __fastcall TFormEditCommercSell1::SpeedButton3Click(TObject *Sender)
{
    MainForm->TabPricelist_Datasource_Main->DataSet->FieldByName("CLIENT")->AsInteger=0;
	// Вызов процедуры обновления сведений о клиенте
	ProcRefreshClient(this);
...
void __fastcall TFormEditCommercSell1::Button5Click(TObject *Sender)
{
	// Кнопка назад
...
void __fastcall TFormEditCommercSell1::Button3Click(TObject *Sender)
{
	// Кнопка вперед
...
void __fastcall TFormEditCommercSell1::ProcSave(TObject *Sender)
{
    //Фиксация изменений
	MainForm->TabPricelist_Datasource_Main->DataSet->CheckBrowseMode();
	//Записать изменения в базу данных
...
void __fastcall TFormEditCommercSell1::RefreshAgent(TObject *Sender)
{
...
void __fastcall TFormEditCommercSell1::Agent_ComboBoxClick(TObject *Sender)
{
	 Agent_datasource->DataSet->Active=true;
	 Agent_datasource->DataSet->First();
...
void __fastcall TFormEditCommercSell1::Button1Click(TObject *Sender)
{
...
void __fastcall TFormEditCommercSell1::Button2Click(TObject *Sender)
{
...
void __fastcall TFormEditCommercSell1::Button7Click(TObject *Sender)
{
...
void __fastcall TFormEditCommercSell1::Typehouse_ButtonClick(TObject *Sender)
{
