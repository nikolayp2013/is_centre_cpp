...
#ifndef UnitFormEditHousePurchH
#define UnitFormEditHousePurchH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TFormEditHousePurch : public TForm
{
__published:	// IDE-managed Components
	...
	TDBMemo *Marker_DBMemo;
	TLabel *Label6;
	TDBLookupComboBoxCentre *Formpurch_DBLookupComboBoxCentre;
	TLabel *Label7;
	TLabel *Label62;
	TShape *Shape2;
	TLabel *Label8;
	...
	TDBCheckBox *Phone_DBCheckBox;
	TDBCheckBox *Waterdrain_DBCheckBox;
	TDBCheckBox *Garage_DBCheckBox;
	...
	void __fastcall Realstate_ButtonClick(TObject *Sender);
...
public:		// User declarations
	__fastcall TFormEditHousePurch(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFormEditHousePurch *FormEditHousePurch;
//---------------------------------------------------------------------------
#endif
