...
#pragma resource "*.dfm"
TFormFilterAddHouse *FormFilterAddHouse;
int leftside;
extern int leftside;
...
//---------------------------------------------------------------------------
__fastcall TFormFilterAddHouse::TFormFilterAddHouse(TComponent* Owner, TIBDatabase * MainConn_loc)
	: TForm(Owner)
{
...
void __fastcall TFormFilterAddHouse::StreetFilter(TObject *Sender)
{
...
void __fastcall TFormFilterAddHouse::SpeedButton9Click(TObject *Sender)
{
    strFilterAdd = "";
	Close();
}
...
void __fastcall TFormFilterAddHouse::SpeedButton7Click(TObject *Sender)
{
	strFilterAdd = "";
...
void __fastcall TFormFilterAddHouse::FormResize(TObject *Sender)
{
	//FormFilterAdd->Left = leftside - FormFilterAdd->Width;
}
//---------------------------------------------------------------------------

void __fastcall TFormFilterAddHouse::FormShow(TObject *Sender)
{
...
void __fastcall TFormFilterAddHouse::Region_ComboBoxClick(TObject *Sender)
{
	StreetFilter(this);
	Table_Streets->First();
...
void __fastcall TFormFilterAddHouse::Street_EditKeyUp(TObject *Sender, WORD &Key, TShiftState Shift)
...
void __fastcall TFormFilterAddHouse::SpeedButton1Click(TObject *Sender)
{
	// Добавить улицу
...
void __fastcall TFormFilterAddHouse::SpeedButton2Click(TObject *Sender)
{
...
void __fastcall TFormFilterAddHouse::SpeedButton3Click(TObject *Sender)
{
...
void __fastcall TFormFilterAddHouse::SpeedButton6Click(TObject *Sender)
{
...
void __fastcall TFormFilterAddHouse::SpeedButton5Click(TObject *Sender)
{
	Livearea1_Edit->Text = "";
	Livearea2_Edit->Text = "";
}
...
void __fastcall TFormFilterAddHouse::SpeedButton4Click(TObject *Sender)
{
...
void __fastcall TFormFilterAddHouse::SpeedButton8Click(TObject *Sender)
{
	// Параметры фильтра
