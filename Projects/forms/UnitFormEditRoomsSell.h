...
#ifndef UnitFormEditRoomsSellH
#define UnitFormEditRoomsSellH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
class TFormEditRoomsSell : public TForm
{
...
public:		// User declarations
	__fastcall TFormEditRoomsSell(TComponent* Owner);
...
//};
//---------------------------------------------------------------------------
extern PACKAGE TFormEditRoomsSell *FormEditRoomsSell;
//---------------------------------------------------------------------------
#endif
