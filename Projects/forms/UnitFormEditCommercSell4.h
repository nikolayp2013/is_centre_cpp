...
#ifndef UnitFormEditCommercSell4H
#define UnitFormEditCommercSell4H
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
class TFormEditCommercSell4 : public TForm
{
__published:	// IDE-managed Components
	...
	TDBEdit *Hor_DBEdit;
	TDBEdit *Vert_DBEdit;
	TDBCheckBox *Mehpogruz_DBCheckBox;
	TDBCheckBox *Train_DBCheckBox;
	TDBCheckBox *Rampa_DBCheckBox;
	TDBCheckBox *Transp_DBCheckBox;
	TDBMemo *Profile_DBMemo;
	TLabel *Label63;
...
public:		// User declarations
	__fastcall TFormEditCommercSell4(TComponent* Owner);
...
//};
//---------------------------------------------------------------------------
extern PACKAGE TFormEditCommercSell4 *FormEditCommercSell4;
//---------------------------------------------------------------------------
#endif
